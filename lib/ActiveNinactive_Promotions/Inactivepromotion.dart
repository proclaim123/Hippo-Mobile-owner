...
class Inactive_promotion extends StatefulWidget {
  @override
  _Inactive_promotionState createState() => _Inactive_promotionState();
}

class _Inactive_promotionState extends State<Inactive_promotion> {
  @override
                      ...
                      children: [
                        ...
                        ButtonTheme(
                          ...
                          child: RaisedButton(
                            ...
                            child: Text("ACTIVE PROMOTION",style: TextStyle(color: Colors.white),),
                          ),
                        ),
                      ],
                    )
