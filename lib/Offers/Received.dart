...
class Received_offers extends StatefulWidget {
  @override
  _Received_offersState createState() => _Received_offersState();
}

class _Received_offersState extends State<Received_offers> {
            ...
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("OFFERS 25",style: TextStyle(color: Colors.lightGreenAccent,fontWeight: FontWeight.normal,fontSize: 13.0),),
