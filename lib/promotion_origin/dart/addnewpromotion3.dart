...
import 'addnewpromotion4.dart';
import 'addnewpromotions4.dart';

class AddNewPromotion03 extends StatefulWidget {
  @override
  _AddNewPromotion03State createState() => _AddNewPromotion03State();
}

class _AddNewPromotion03State extends State<AddNewPromotion03> {
                  ...
                  child: RaisedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AddNewPromotion04()),
                        );
                      },
                      child: Text(
                        'NEXT',
            ...
            itemBuilder: (BuildContext context, int index) {
              return InkWell(
                ...
                child: Card(
                    ...
                    color: nameArray[index] == "Everyone"
                        ? Color(0xFF848484)
                        : Color(0xFF9389AA),
